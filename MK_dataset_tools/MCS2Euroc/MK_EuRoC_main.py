...
img_count_path = "E:\SLAM\DSOL-realsense\qqm_new_dso_Euroc\qqm_new_beach\mav0\cam0\data" # 统计图片数量，用于生成timestamp.txt文件
timestamp_out_path = "E:\SLAM\DSOL-realsense\qqm_new_dso_Euroc\qqm_new_beach\TimeStamps.txt"  # 默认输出到当前工作目录
